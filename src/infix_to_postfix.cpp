...
void InfixToPostfix::handleClosingParenthesis(std::stack<char> &operatorStack, std::vector<std::string> &postfix)
{
...
void InfixToPostfix::handleOperandOrOperator(std::string s, bool &nextConcat,
                                             std::stack<char> &operatorStack,
                                             std::vector<std::string> &postfix)
{
